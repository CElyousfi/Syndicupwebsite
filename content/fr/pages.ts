...
export const demo: SiteContent["demo"] = {
  ...
  formLede: "Trois champs. La suite se fait sur WhatsApp, à l'heure qui vous arrange.",
  fields: { name: "Nom", phone: "Téléphone", lots: "Nombre de lots" },
  placeholders: { name: "Nom et prénom", phone: "+212 6 00 00 00 00", lots: "48" },
