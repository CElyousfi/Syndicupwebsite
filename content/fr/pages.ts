...
export const tarifs: SiteContent["tarifs"] = {
  ...
  neverBilled: [
    { icon: "upload", title: "La reprise de données", desc: "Quelle que soit l'épaisseur du classeur." },
    { icon: "building", title: "La mise en service", desc: "Paramétrage, tantièmes, comptes d'ouverture." },
    { icon: "mobile", title: "Les comptes résidents", desc: "Illimités, y compris locataires et MRE." },
    { icon: "unlock", title: "La sortie", desc: "Export complet de vos données, à tout moment." },
  ],
  compareKicker: "LIGNE À LIGNE",
  compareTitle: "Ce que chaque plan comprend",
  compareRows: [
    { feature: "Comptabilité et les 12 annexes", cells: [true, true, true] },
    { feature: "Appels de fonds, quittances, relances", cells: [true, true, true] },
    { feature: "Assemblées : convocation, quorum, PV", cells: [true, true, true] },
    { feature: "Dépenses avec justificatif obligatoire", cells: [true, true, true] },
    { feature: "Application résidents (iOS, Android, web)", cells: [true, true, true] },
    { feature: "Écran de loge pour le gardien", cells: [true, true, true] },
    { feature: "Location courte durée", cells: [true, true, true] },
    { feature: "Vue portefeuille multi-résidences", cells: ["—", "—", true] },
    { feature: "Permissions par gestionnaire", cells: ["—", "—", true] },
    { feature: "Application au nom du cabinet", cells: ["—", "—", true] },
    { feature: "Reprise de données", cells: ["Gratuite", "Gratuite", "Par vagues, gratuite"] },
    { feature: "Support", cells: ["WhatsApp", "WhatsApp, une personne dédiée", "Interlocuteur dédié"] },
    { feature: "Export complet à la sortie", cells: [true, true, true] },
  ],
...
export const apropos: SiteContent["apropos"] = {
  ...
  principles: [
    ...
    { icon: "gift", title: "Gratuit là où ça compte", desc: "La majorité des immeubles marocains ont moins de 30 lots et n'ont jamais eu d'outil. Pour eux, c'est gratuit, sans limite de durée." },
